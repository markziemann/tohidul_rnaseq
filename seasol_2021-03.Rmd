--- title: "Tohidul: does Seasol prime gene expression" author: "Mark Ziemann" date: "`r 
Sys.Date()`" output:
  html_document:
    toc: true
theme: cosmo
...
del3m <- mitch_calc(x=m,genesets=genesets,priority="effect")
mitch_barplot(del3m)
...
del5m <- mitch_calc(x=m,genesets=genesets,priority="effect")
mitch_barplot(del5m)
...
der3m <- mitch_calc(x=m,genesets=genesets,priority="effect")
mitch_barplot(der3m)
...
der5m <- mitch_calc(x=m,genesets=genesets,priority="effect")
mitch_barplot(der5m)
